  ...
  victoria: [
    {
      ...
      emoji: "💋",
      items: [
        { name: "Lip Blushing", duration: "2–3 Std.", price: `ab 280 ${E}`, desc: "Natürliche Lippenfarbe, sanft & langanhaltend", popular: true, icon: "👄" },
        { name: "Powder Brows", duration: "2–3 Std.", price: `ab 250 ${E}`, desc: "Pudrige, natürlich wirkende Augenbrauen", popular: true, icon: "✨" },
        { name: "Eyeliner", duration: "1,5–2 Std.", price: `ab 200 ${E}`, desc: "Dezenter oder intensiver permanenter Eyeliner", icon: "👁️" },
        { name: "Lip Auffrischung", duration: "1,5 Std.", price: `ab 150 ${E}`, desc: "Touch-up für bestehende Behandlung", icon: "💕" },
        { name: "Brows Auffrischung", duration: "1,5 Std.", price: `ab 130 ${E}`, desc: "Touch-up für bestehende Augenbrauen", icon: "🌟" },
      ],
    },
    {
      ...
      emoji: "🍯",
      items: [
        { name: "Full Face", duration: "20 Min.", price: `25 ${E}`, icon: "🌸" },
        { name: "Deep Bikini", duration: "30 Min.", price: `30 ${E}`, icon: "🌿" },
        { name: "Bikini Area", duration: "20 Min.", price: `20 ${E}`, icon: "🌿" },
        { name: "Full Legs", duration: "45 Min.", price: `40 ${E}`, icon: "✨" },
        { name: "Legs bis Knie", duration: "30 Min.", price: `30 ${E}`, icon: "✨" },
        { name: "Full Arms", duration: "30 Min.", price: `30 ${E}`, icon: "💫" },
        { name: "Arms bis Ellbogen", duration: "20 Min.", price: `25 ${E}`, icon: "💫" },
        { name: "Achseln", duration: "15 Min.", price: `15 ${E}`, icon: "🌸" },
        { name: "Bauch", duration: "20 Min.", price: `20 ${E}`, icon: "🌸" },
        { name: "Po", duration: "20 Min.", price: `20 ${E}`, icon: "🌸" },
        { name: "Lendenbereich", duration: "20 Min.", price: `25 ${E}`, icon: "🌸" },
        { name: "Rücken", duration: "40 Min.", price: `40 ${E}`, icon: "🌸" },
      ],
    },
  ],
  cindy: [
